...
public abstract interface EventDao {
    ...
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.example.calendar.data.local.db.entity.EventEntity>> getAllEventMonth();
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM EventTable WHERE event_month =:month")
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.example.calendar.data.local.db.entity.EventEntity>> getAllEventByMonth(long month);
