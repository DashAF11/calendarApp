 ...
 */
public abstract class Hilt_EventFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EventFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EventFragment_GeneratedInjector) this.generatedComponent()).injectEventFragment(UnsafeCasts.<EventFragment>unsafeCast(this));
    }
  }
