 ...
 */
public abstract class Hilt_AddEventFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEventFragment() {
    super();
  }

  Hilt_AddEventFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEventFragment_GeneratedInjector) this.generatedComponent()).injectAddEventFragment(UnsafeCasts.<AddEventFragment>unsafeCast(this));
    }
  }
